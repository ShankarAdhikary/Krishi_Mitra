...
class PlotFeaturesService:
    ...
    def _snap_optical(self, plot_id: str, obs_date: date) -> dict:
        ...
        delta_7d = (ndvi - self._safe_float(prior_7d.value)) if prior_7d and ndvi is not None else None
        delta_14d = (ndvi - self._safe_float(prior_14d.value)) if prior_14d and ndvi is not None else None
